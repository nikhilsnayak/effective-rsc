...
type RadioGroupItemProps<Value> = Omit<RadioPrimitive.Root.Props<Value>, 'id' | 'render'> & {
  readonly id: string;
};

function RadioGroupItem<Value>({ className, id, ...props }: RadioGroupItemProps<Value>) {
  return (
    <RadioPrimitive.Root
      data-slot='radio-group-item'
      id={id}
      render={<span id={`${id}-control`} />}
      className={cn(
